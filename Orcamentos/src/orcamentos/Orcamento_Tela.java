...
public class Orcamento_Tela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PDF.setBounds(440, 570, 100, 27);

        jLabel1.setText("Codigo Do Produto");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(440, 70, 120, 20);
        ...
        Cod.setBounds(460, 90, 68, 26);

        jLabel2.setText("Produto");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(470, 120, 50, 16);
        ...
        Produto.setBounds(390, 140, 220, 26);
        getContentPane().add(Qtd);
        Qtd.setBounds(450, 430, 80, 26);

        jLabel3.setText("Quantidade");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(450, 410, 80, 16);

        jLabel4.setText("Valor Unitario");
        getContentPane().add(jLabel4);
        jLabel4.setBounds(450, 460, 80, 16);
        ...
        ValorUN.setBounds(450, 480, 75, 26);
        ...
        NVItem.setBounds(420, 530, 140, 27);

        Indus.setText("UNIVIPAX COMERCIOS");
        getContentPane().add(Indus);
        Indus.setBounds(390, 380, 220, 26);

        jLabel5.setText(" Indústria");
        getContentPane().add(jLabel5);
        jLabel5.setBounds(460, 360, 60, 16);
        ...
        jScrollPane1.setBounds(380, 250, 238, 90);

        jLabel6.setText("Descrição");
        getContentPane().add(jLabel6);
        jLabel6.setBounds(457, 220, 60, 16);

        setSize(new java.awt.Dimension(991, 644));
    ...
    private void PDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PDFActionPerformed
        try {
            ...
            Logger.getLogger(Orcamento_Tela.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void GerarPDF() throws BadElementException, IOException {
        ...
        try {
            ...
            Font normalFont = new Font(Font.FontFamily.HELVETICA, 9, Font.ITALIC, BaseColor.DARK_GRAY);
            Font fontVermelha = new Font(Font.FontFamily.HELVETICA, 12, Font.NORMAL, BaseColor.RED);

            PdfPTable T = new PdfPTable(2);
            Image imagem = Image.getInstance("C:\\Users\\geova_16fe4ev\\OneDrive\\Documentos\\Orcamentos\\src\\IMG\\logoUNI.png"); // Substitua pelo caminho da sua imagem
            imagem.scaleToFit(60, 60); // Ajusta a imagem para caber na célula
            PdfPCell celulaImagem = new PdfPCell(imagem);
            celulaImagem.setPadding(10f);
            celulaImagem.setBorderWidthRight(0);
            T.addCell(celulaImagem);

            Paragraph INFUNI = new Paragraph();
            INFUNI.add(new Chunk("UNIVIPAX COMERCIOS\n", boldFont));
            INFUNI.add(new Chunk("Rua Agostinho de Farias, 257\n"
                    + "São Paulo/SP\n", boldFont));
            INFUNI.add(new Chunk("CEP: ", normalFont));
            INFUNI.add(new Chunk("08280-100\n", boldFont));
            INFUNI.add(new Chunk("Telefone:", normalFont));
            INFUNI.add(new Chunk("(11) 2748-4007\n"
                    + "(11) 99739-1974", boldFont));
            PdfPCell INFUNI1 = new PdfPCell(INFUNI);
            INFUNI1.setBorderWidthLeft(0);
            T.addCell(INFUNI1);
            float[] columnWidths1 = {1f, 5F};
           ...
           T.setWidthPercentage(100);
            ...
            float[] columnWidths3 = {1.50f,1f};
            Cliente.setWidths(columnWidths3);
            ...
            PdfPTable Terceira = new PdfPTable(1);
            Paragraph InfTrans = new Paragraph();
            InfTrans.add(new Chunk("Informações sobre o Transporte\n", normalFont));
            InfTrans.add(new Chunk("Transportadora:", normalFont));
            InfTrans.add(new Chunk("Exclusive Cargas\n", boldFont));
            InfTrans.add(new Chunk(" Telefone:", normalFont));
            InfTrans.add(new Chunk(" (11) 97373-0414\n", boldFont));
            InfTrans.add(new Chunk(" Email:", normalFont));
            PdfPCell T3 = new PdfPCell(InfTrans);
            T3.setBorderWidthBottom(0);
            Terceira.addCell(T3);
            //Cria uma Tabela de 6 Colunas
            PdfPTable ofc = new PdfPTable(6);
            PdfPCell coluna1 = new PdfPCell(new Paragraph("Cód"));
            PdfPCell coluna2 = new PdfPCell(new Paragraph("Produto"));
            PdfPCell coluna3 = new PdfPCell(new Paragraph("Quantidade"));
            PdfPCell coluna4 = new PdfPCell(new Paragraph("Industria"));
            PdfPCell coluna5 = new PdfPCell(new Paragraph("Valor Unitário"));
            PdfPCell coluna6 = new PdfPCell(new Paragraph("Total"));
            //Cor da Célula 
            ...
            Paragraph produto2 = new Paragraph();
            produto2.add(new Chunk(produto + "\n"));
            produto2.add(new Chunk(desc + "\n ", fontVermelha));
            PdfPCell quantidade = new PdfPCell(new Paragraph(String.valueOf(Quantidade)));
            PdfPCell Ind = new PdfPCell(new Paragraph(Indust));
            ...
            ofc.addCell(codigo);
            ofc.addCell(produto2);
            ofc.addCell(Ind);
            ofc.addCell(quantidade);
            ofc.addCell(valorUnitario);
            ofc.addCell(total);
            float[] columnWidths = {0.75f, 2.5f, 2.5f, 1.50f, 1f, 1.35f};
            ofc.setWidths(columnWidths);
            ofc.setWidthPercentage(50);
            PdfPCell T4 = new PdfPCell(ofc);
            T4.setBorderWidthTop(0);
            Terceira.addCell(T4);
            Terceira.setWidthPercentage(100);
            document.add(Terceira);
